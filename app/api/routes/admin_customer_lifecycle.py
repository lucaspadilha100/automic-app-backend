...
def list_lifecycle_customers(
    ...
    return [
        CustomerLifecycleCustomerListItem(
            ...
            name=tc.customer_account.name if tc.customer_account else "—",
            phone=tc.customer_account.phone if tc.customer_account else None,
            email=tc.customer_account.email if tc.customer_account else None,
            customer_since=tc.customer_account.created_at if tc.customer_account else None,
